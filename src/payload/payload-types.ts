...
export interface Account {
  ...
  balance: number;
  /**
   * Credit limit in cents (for Credit Cards)
   */
...
export interface Budget {
  ...
  title?: string | null;
  /**
   * e.g. "Main Groceries" or "Holiday Fund"
   */
  name?: string | null;
  /**
   * YYYY-MM format
...
export interface Category {
  ...
  icon?: string | null;
  /**
   * Color hex code or Tailwind class
   */
  color?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "import-settings".
 */
export interface ImportSetting {
  id: string;
  /**
   * The URL shown to users who need help converting Excel files to CSV.
   */
  tutorialUrl: string;
  updatedAt?: string | null;
  createdAt?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "import-settings_select".
 */
export interface ImportSettingsSelect<T extends boolean = true> {
  tutorialUrl?: T;
  updatedAt?: T;
  createdAt?: T;
  globalType?: T;
